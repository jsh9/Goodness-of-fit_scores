function varargout = GofScoresGUI(varargin)
% GOFSCORESGUI MATLAB code for GofScoresGUI.fig
%      GOFSCORESGUI, by itself, creates a new GOFSCORESGUI or raises the existing
%      singleton*.
%
%      H = GOFSCORESGUI returns the handle to a new GOFSCORESGUI or the handle to
%      the existing singleton*.
%
%      GOFSCORESGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GOFSCORESGUI.M with the given input arguments.
%
%      GOFSCORESGUI('Property','Value',...) creates a new GOFSCORESGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GofScoresGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GofScoresGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GofScoresGUI

% Last Modified by GUIDE v2.5 02-Aug-2017 21:58:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GofScoresGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @GofScoresGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GofScoresGUI is made visible.
function GofScoresGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GofScoresGUI (see VARARGIN)

% Choose default command line output for GofScoresGUI
...
function varargout = GofScoresGUI_OutputFcn(hObject, eventdata, handles) 
